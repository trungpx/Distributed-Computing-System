...
public class BankImpl extends UnicastRemoteObject implements Bank
{
    ...
    public BankImpl() throws RemoteException
    {
         ...
         */
        super();
        accountList.put(123, new Account(123, 123, 10000));
        accountList.put(20188134, new Account(20188134, 20188134, 50000));
        accountList.put(1221, new Account(1221, 1221, 20000));
    }
    ...
    {
        return accountList.get(name).deposit; //Check request account ID's deposit.
    }

    @Override
    public ArrayList<TransInfo> checkTransRecord(int name) throws RemoteException {
        return accountList.get(name).transRecord; //Check transfer records.
    }
}
